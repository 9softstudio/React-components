...
var invariant = __webpack_require__(1);
var lowPriorityWarning = __webpack_require__(7);
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'a',
                    { className: this.props.isActive ? "active" : "", href: this.props.url, onClick: this.props.onClick },
                    this.props.label
                )
            );
        }
...
var Tabs = function (_Component) {
    ...
    function Tabs(props) {
        ...
        _this.tabComponents = _react2.default.Children.toArray(props.children);
        var tabState = _this.tabComponents.map(function (item) {
    ...
    _createClass(Tabs, [{
        key: '_renderActiveTabContent',
        value: function _renderActiveTabContent() {
            var activeTabIndex = this.state.tabState.findIndex(function (x) {
                return x;
            });
        ...
        value: function onTabChange(tabIndex) {
            var newTabState = this.state.tabState.map(function (item, index) {
        ...
        key: '_renderTabComponents',
        value: function _renderTabComponents() {
            var _this2 = this;

            return this.tabComponents.map(function (item, index) {
                return _react2.default.createElement(_Tab2.default, { key: 'tab' + index,
                    isActive: _this2.state.tabState[index],
                    label: item.props.label,
                    onClick: _this2.onTabChange.bind(_this2, index),
                    url: item.props.url
                });
            });
        }
